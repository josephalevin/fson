...
${OBJECTDIR}/src/fson_example.o: src/fson_example.f95 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/fson_example.o src/fson_example.f95

${OBJECTDIR}/src/fson.o: src/fson.f95 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/fson.o src/fson.f95

${OBJECTDIR}/src/fson_string_m.o: src/fson_string_m.f95 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/fson_string_m.o src/fson_string_m.f95

${OBJECTDIR}/src/fson_value_m.o: src/fson_value_m.f95 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/fson_value_m.o src/fson_value_m.f95
